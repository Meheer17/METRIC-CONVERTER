...
suite('Unit Tests', function(){
    ...
    suite("Function convertHandler.getNum(input)",() => {
        ...
        test("fractional input with decimal", (done) => {
            let input = "9/2.3L";
            assert.equal(convertHandler.getNum(input), 9/2.3);
            done();
        });
    ...
    suite("Funtion convertHandler.getUnit(input)", () => {
        ...
        test("unknown unit input", (done) => {
            assert.equal(convertHandler.getUnit("34kilogram"), undefined);
            done();
        });
